        ...
        if (damageEvent instanceof EntityDamageByEntityEvent) {
            ...
            if (event.getDamager() instanceof Projectile) {
                ...
                if (projectile.getShooter() instanceof BlockProjectileSource) {
                    ...
                    if (placer != null) {
                        if (placer.isOnline()) {
                            return new DispensedProjectileDamageInfo(projectile, (Player) placer, projectileDistance, placer);
                        }
                        else {
                            return new DispensedProjectileDamageInfo(projectile, null, projectileDistance, placer);
                        }
                    }
                }
